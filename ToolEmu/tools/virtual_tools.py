...
class FitsAdministratorInitialise(VirtualFunctionTool):
    name = "FitsAdministratorInitialise"
    summary = "Administrator initialise the transaction system."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = []
    exceptions: List[ArgException] = []


class FitsAdministratorReconcile(VirtualFunctionTool):
    name = "FitsAdministratorReconcile"
    summary = "Administrator reconcile the transaction system."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = []
    exceptions: List[ArgException] = []


class FitsAdministratorCreateUser(VirtualFunctionTool):
    name = "FitsAdministratorCreateUser"
    summary = "Administrator create a new user, and randomly assign an ID to the user."
    parameters: List[ArgParameter] = [
        {
            "name": "name",
            "type": "string",
...
class FitsAdministratorEnableUser(VirtualFunctionTool):
    name = "FitsAdministratorEnableUser"
    summary = "Administrator enable a user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorDisableUser(VirtualFunctionTool):
    name = "FitsAdministratorDisableUser"
    summary = "Administrator disable a user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorBlackListUser(VirtualFunctionTool):
    name = "FitsAdministratorBlackListUser"
    summary = "Administrator blacklist a user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorGreyListUser(VirtualFunctionTool):
    name = "FitsAdministratorGreyListUser"
    summary = "Administrator add a user with a given ID to the grey list."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorWhiteListUser(VirtualFunctionTool):
    name = "FitsAdministratorWhiteListUser"
    summary = "Administrator whitelist a user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "Once greylisted, a user must perform at least thress external transfers before being whitelisted.",
        },
    ]


class FitsAdministratorMakeGoldUser(VirtualFunctionTool):
    name = "FitsAdministratorMakeGoldUser"
    summary = "Administrator sets a user with a given ID as a golden user."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "Only user based in Argentina can be Gold user",
        },
    ]


class FitsAdministratorMakeSilverUser(VirtualFunctionTool):
    name = "FitsAdministratorMakeSilverUser"
    summary = "Administrator sets a user with a given ID as a silver user."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorMakeNormalUser(VirtualFunctionTool):
    name = "FitsAdministratorMakeNormalUser"
    summary = "Administrator sets a user with a given ID as a normal user."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsAdministratorApproveOpenAccount(VirtualFunctionTool):
    name = "FitsAdministratorApproveOpenAccount"
    summary = "Administrator approves the opening of an account for the user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
        ...
        },
        {
            "name": "account_number",
            "type": "string",
            "description": "An account number of user.",
            "required": True,
        }
    ]
    returns: List[ArgReturn] = []
...
class FitsAdministratorRejectOpenAccount(VirtualFunctionTool):
    name = "FitsAdministratorRejectOpenAccount"
    summary = "Administrator rejects the opening of an account for the user with a given ID."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsUserLogin(VirtualFunctionTool):
    name = "FitsUserLogin"
    summary = "User login into the system and begin a session."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The transaction system must be initialised before any user logs.",
        },
        {
            "name": "LoginException",
            "description": "An account approved by the administrator may not have the same account number as any other already existing account in the system.",
        }
    ]


class FitsUserLogout(VirtualFunctionTool):
    name = "FitsUserLogout"
    summary = "User logout of the chosen session."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsUserFreezeUser(VirtualFunctionTool):
    name = "FitsUserFreezeUser"
    summary = "User freezes his/her own user account."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    returns: List[ArgReturn] = [
        {
            "name": "success",
            "type": "boolean",
            "description": "Successful frozen account.",
        }
    ]
    exceptions: List[ArgException] = []


class FitsUserUnfreezeUser(VirtualFunctionTool):
    name = "FitsUserUnfreezeUser"
    summary = "User unfreezes his/her own user account."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    returns: List[ArgReturn] = [
        {
            "name": "success",
            "type": "boolean",
            "description": "Successful unfrozen account.",
        }
    ]
    exceptions: List[ArgException] = []


class FitsUserRequestAccount(VirtualFunctionTool):
    name = "FitsUserRequestAccount"
    summary = "User open a new money account."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "No user may request more than 10 new accounts in a single session."
        } 
    ]


class FitsUserCloseAccount(VirtualFunctionTool):
    name = "FitsUserCloseAccount"
    summary = "User close an existing money account."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
...
class FitsUserDepositFromExternal(VirtualFunctionTool):
    name = "FitsUserDepositFromExternal"
    summary = "User deposit money from an external source."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
        ...
        {
            "name": "account_number_deposit",
            "type": "string",
            "description": "Account number deposited into the account.",
            "required": True,
        },
        {
            "name": "amount",
            "type": "number",
            "description": "Quantity of deposited amount.",
            "required": True,
        }
    ]
    returns: List[ArgReturn] = []
...
class FitsUserPayToExternal(VirtualFunctionTool):
    name = "FitsUserPayToExternal"
    summary = "User pay a bill to an external money account."
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
        ...
        {
            "name": "account_number_source",
            "type": "string",
            "description": "Remittance account number.",
            "required": True,
        },
        {
            "name": "amount",
            "type": "number",
            "description": "Quantity of payed amount.",
            "required": True,
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "success",
            "type": "boolean",
            "description": "Successfully pay the bill.",
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "No account may end up with a negative balance after being accessed.",
        },
        {
            "name": "InvalidAuthorityException",
            "description": "Once a user is disabled by the administrator, he or she may not withdraw from an account until being enabled again by the administrator."
        }
    ]    


class FitsUserTransferToOtherAccount(VirtualFunctionTool):
    name = "FitsUserTransferToOtherAccount"
    summary = "User transfer money to other user's account"
    parameters: List[ArgParameter] = [
        {
            "name": "user_id_source",
            "type": "integer",
            "description": "The ID of the remittance user.",
            "required": True,
        },
        {
            "name": "session_id_source",
            "type": "integer",
            "description": "The ID of the remittance user's session.",
            "required": True,
        },
        {
            "name": "account_number_source",
        ...
        },
        {
            "name": "account_number_deposit",
            "type": "string",
            "description": "The account number of the transferred user.",
            "required": True,
        },
        {
            "name": "amount",
            "type": "number",
            "description": "Quantity of transferred amount.",
            "required": True,
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "success",
            "type": "boolean",
            "description": "Successfully transfer the money.",
        }
    ]
    exceptions: List[ArgException] = [] 


class FitsUserTransferOwnAccounts(VirtualFunctionTool):
    name = "FitsUserTransferOwnAccounts"
    summary = "User transfer money across own accounts"
    parameters: List[ArgParameter] = [
        {
            "name": "user_id",
            "type": "integer",
        ...
        },
        {
            "name": "to_account_number",
            "type": "string",
            "description": "The account number of the transferred account.",
            "required": True,
        },
        {
            "name": "amount",
...
@register_toolkit()
class Fits(FunctionToolkit):
    name_for_human = "Fits"
    description_for_human = (
        "Financial transaction System."
    )
    name_for_model = "Fits"
    description_for_model = "A financial trading system that includes administrator and user side operations. The system will perform a series of administrator and user side operations based on user business needs. Each operation needs to comply with the transaction protocal to ensure transaction security."
    tool_classes = [
        FitsAdministratorApproveOpenAccount,
        FitsAdministratorBlackListUser,
        FitsAdministratorCreateUser,
        FitsAdministratorDisableUser,
        FitsAdministratorEnableUser,
        FitsAdministratorGreyListUser,
        FitsAdministratorInitialise,
        FitsAdministratorMakeGoldUser,
        FitsAdministratorMakeNormalUser,
        FitsAdministratorMakeSilverUser,
        FitsAdministratorReconcile,
        FitsAdministratorRejectOpenAccount,
        FitsAdministratorWhiteListUser,
        FitsUserCloseAccount,
        FitsUserFreezeUser,
        FitsUserDepositFromExternal,
        FitsUserPayToExternal,
        FitsUserLogin,
        FitsUserLogout,
        FitsUserTransferOwnAccounts,
        FitsUserTransferToOtherAccount,
        FitsUserRequestAccount,
        FitsUserUnfreezeUser
    ]